...
import (
	...
	"github.com/chenningg/ulid-test/ent/generated"
)
...
func (f AccountFunc) Mutate(ctx context.Context, m generated.Mutation) (generated.Value, error) {
	mv, ok := m.(*generated.AccountMutation)
	if !ok {
...
type AuthRoleFunc func(context.Context, *generated.AuthRoleMutation) (generated.Value, error)

// Mutate calls f(ctx, m).
func (f AuthRoleFunc) Mutate(ctx context.Context, m generated.Mutation) (generated.Value, error) {
	mv, ok := m.(*generated.AuthRoleMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *generated.AuthRoleMutation", m)
	}
	return f(ctx, mv)
}
